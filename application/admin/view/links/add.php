...
<div class="layui-form-item">
    <label for="seo_title" class="layui-form-label"><span class="x-red">*</span>链接 </label>
    <div class="layui-input-block">
        <input type="text" id="link" name="link"  lay-verify="required" lay-reqText="链接不能为空"
               autocomplete="off" class="layui-input" value="<?php echo $row['link']; ?>">
    </div>
</div>
