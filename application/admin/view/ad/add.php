...
<div class="layui-form-item">
    <label for="username" class="layui-form-label"> <span class="x-red">*</span>点击跳转链接 </label>
    <div class="layui-input-inline">
        <input type="text" id="link_url" name="link_url" autocomplete="off" class="layui-input" value="<?php echo $row['link_url']; ?>">
    </div>
</div>
