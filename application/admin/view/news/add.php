...
<div class="layui-form-item">
    ...
    <div class="layui-input-block"> <?php echo_editor("content", $row) ?>
...
<div class="layui-form-item">
    <label for="keywords" class="layui-form-label"> 文章关键词 </label>
    <div class="layui-input-block">
        <input type="text" id="keywords" name="keywords"
               autocomplete="off" class="layui-input" value="<?php echo $row['keywords']; ?>">
    </div>
</div>


<div class="layui-form-item">
    <label for="subtitle" class="layui-form-label"> 文章摘要 </label>
    <div class="layui-input-block">
    <textarea name="subtitle" class="layui-textarea"
              placeholder="不填写自动截取文章内容130个字符"><?php echo $row['subtitle'] ?></textarea>
    </div>
</div>
...
<div class="layui-form-item">
    <label for="seo_title" class="layui-form-label"> SEO标题 </label>
    <div class="layui-input-inline">
...
<div class="layui-form-item">
    <label for="seo_description" class="layui-form-label"> SEO描述 </label>
    <div class="layui-input-block">
