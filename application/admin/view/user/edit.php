...
<div class="layui-form-item">
    ...
    <div class="layui-form-mid layui-word-aux" style="color: #000!important;">{$row['username']}</div>
</div>
...
<div class="layui-form-item">
    ...
    <div class="layui-form-mid layui-word-aux">不修改密码请不要填写输入框,修改密码请填入6-20个字符（只能为A-Z，a-z，0-9，下划线组合）</div>
</div>
