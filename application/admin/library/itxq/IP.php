<?php
	...
	namespace app\admin\library\itxq;
	...
	class IP
	{
		...
		public function __construct($path = '')
		{
			if (!empty($path) && is_file($path)) {
				...
				$this->ipDataPath = __DIR__ . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . 'ip.dat';
			}
		}
		 ...
		 * @return array|string
		 */
		public function getIpInfo($ip = '', $type = self::IP_INFO_ALL)
		{
			if (empty($ip)) {
				$ip = $this->ip();
			}
		 ...
		 * @return boolean
		 */
		public function isValidIP(string $ip, $type = '')
		{
		 ...
		 */
		protected function lookup(string $ip, string $path)
		{
		 ...
		 * @param string $path
		 */
		protected function ini(string $path)
		{
